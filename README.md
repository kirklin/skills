...
A curated collection of [Agent Skills](https://agentskills.io/home) reflecting [Kirk Lin](https://github.com/kirklin)'s preferences, experience, and best practices, along with usage documentation for the tools.
...
```bash
pnpx skills add kirklin/skills --skill='*'
```

or to install all of them globally:

```bash
pnpx skills add kirklin/skills --skill='*' -g
```
...
Manually maintained by Kirk Lin with his preferred tools, setup conventions, and best practices.

| Skill                     | Description |
|---------------------------|-------------|
| [kirklin](skills/kirklin) | Kirk Lin's preferences and best practices for app/library projects (eslint, pnpm, vitest, etc.) |

### Skills Generated from Official Documentation

> Unopinionated but with tilted focus (e.g. TypeScript, ESM, Composition API, and other modern stacks)

Generated from official documentation and fine-tuned by Kirk.
