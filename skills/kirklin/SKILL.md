---
name: kirklin
description: Kirk Lin's opinionated tooling and conventions for JavaScript/TypeScript projects. Use when setting up new projects, configuring ESLint/Prettier alternatives, monorepos, library publishing, or when the user mentions Kirk Lin's preferences.
metadata:
  author: Kirk Lin
  version: "2026.02.08"
---
...
For detailed configuration options: [kirklin-eslint-config](references/kirklin-eslint-config.md)
...
|-------|-------------|--------------------------------------------------------------|
| ESLint Config | Framework support, formatters, rule overrides, VS Code settings | [kirklin-eslint-config](references/kirklin-eslint-config.md) |
